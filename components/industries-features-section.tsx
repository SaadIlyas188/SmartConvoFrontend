          ...
          <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pb-0 pt-16">
              <motion.div
                ...
                className="bg-[#0a0a0a] border border-white/10 rounded-t-2xl p-12 max-w-3xl w-full h-full relative overflow-y-auto"
              ...
              >
                ...
                <motion.button
                  ...
                  onClick={() => setSelectedFeature(null)}
                  className="absolute top-6 right-6 w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:border-cyan-500/50 transition-colors"
                >
                  ...
                  <>
                    ...
                    >
                      <img
                        src={
                          selectedFeature === 1
                            ? "/images/ai-voice-intelligence.jpg"
                            : selectedFeature === 2
                              ? "/images/scale-speed.jpg"
                              : "/images/industry-tailored.jpg"
                        }
                    ...
                    <div className="mb-8">
                      <motion.h2
                        ...
                        className="text-4xl lg:text-5xl tracking-tight font-light leading-tight text-white"
                        transition={{
                          type: "spring",
                          stiffness: 120,
                          damping: 20,
                    ...
                    >
                      {features
                        ...
                        ?.fullContent.paragraphs.map((paragraph, index) => (
                          <p key={index} className="text-white/60 text-lg leading-relaxed text-pretty">
                            {paragraph}
                          </p>
                        ))}
